...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "310", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-310/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "es")
  })
  @ApiOperation(value = "tes", notes = " ")
  public Response tes() {
    ...
    // es
    boolean es_condition = true;
    if(es_condition) {
      JSONObject es = new JSONObject();

      

      return Response.status(HttpURLConnection.HTTP_OK).entity(es.toJSONString()).build();
    }
    return null;
  }
