 ...
 * 310 - Test Class
 *
 * This class provides a basic testing framework for the microservice 310. It was
...
public class ResTest {
  ...
  public void testtes() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/tes", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testtes': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
